...
void Gun::shoot(TypeOfShot t) {
	...
	{
		case PISTOLA:
			p = new Projectile(0.0035 * 5, {255, 255, 0, 1}, this);
			...
			break;
		case CAÑON:
			p = new Projectile(0.175 * 5, { 0, 0, 0, 1 }, this);
			p->setVelocity(cameraDir * 30); // 1800 m/s
			...
			break;
		case TANQUE:
			p = new Projectile(0.06 * 5, { 255, 0, 0, 1 }, this);
			p->setVelocity(cameraDir * 150); // 
